//! Logo art and its brand gradient, regenerate from assets/coldluau.png with ImageMagick if the logo changes
...
/// Gradient row color, light ice down through brand to deep teal
pub fn row_color(row: usize, rows: usize) -> (u8, u8, u8) {
    const TOP: (u8, u8, u8) = (0xDE, 0xFF, 0xFF); // near white ice
    const BOTTOM: (u8, u8, u8) = (0x2F, 0x9E, 0xC4); // deep glacial teal
